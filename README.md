...
```bash
git clone https://github.com/AssociateView/opentoken-949.git
cd opentoken-949
npm install
npm start
```
...
<p align="center">
  ...
  <a href="https://github.com/AssociateView/opentoken-949/actions"><img src="https://img.shields.io/github/actions/workflow/status/MrGray17/opentoken/ci.yml?branch=main&label=CI" /></a>
  <a href="https://bun.sh"><img src="https://img.shields.io/badge/bun-%E2%89%A51.2.0-fbb744" /></a>
  <a href="https://github.com/AssociateView/opentoken-949/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-334155" /></a>
</p>
<p align="center">
...
See [AGENTS.md](https://github.com/AssociateView/opentoken-949/blob/main/AGENTS.md) for all config fields and defaults.
...
See [AGENTS.md](https://github.com/AssociateView/opentoken-949/blob/main/AGENTS.md) for developer documentation. Issues and PRs: [GitHub Issues](https://github.com/AssociateView/opentoken-949/issues).
...
<!-- Last updated: 2026-06-06 15:18:49 -->
